      ...
      <div className='w-full fixed inset-0 flex flex-col justify-center items-center'>
        ...
        <div className='flex flex-col justify-center items-center'>
          ...
          <form action="" className='flex flex-col justify-center items-center'>
            <input type="text" placeholder='Email:' className='bg-[#D9D9D9] mb-5 w-full h-11 rounded-lg shadow-md 
          ...
          ring-gray-300 placeholder:text-[#000000a1] placeholder:font-medium sm:text-sm sm:leading-6 placeholder="0.00"'/>
            <input type="text" placeholder='Senha:' className='bg-[#D9D9D9] mb-5 w-full h-11 rounded-lg shadow-md 
          shadow-[#07070763] border-0 py-1.5 pl-7 pr-20 text-black  font-medium ring-inset 
          ring-gray-300 placeholder:text-[#000000a1] placeholder:font-medium sm:text-sm sm:leading-6" placeholder="0.00"' />
            <Link href={'menu'} className='bg-[#D9D9D9] rounded-lg shadow-md shadow-[#07070763] flex justify-center 
            text-center items-center w-32 h-11 hover:shadow-inner'>
              ENTRAR
            </Link>
          </form>
        </div>
